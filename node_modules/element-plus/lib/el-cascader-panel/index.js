...
const _hoisted_1 = /* @__PURE__ */ vue.createVNode("span", null, null, -1);
const _hoisted_2 = {
  key: 2,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock("li", {
    ...
    _ctx.multiple ? (vue.openBlock(), vue.createBlock(_component_el_checkbox, {
      ...
      _: 1
    }, 8, ["model-value", "label", "disabled", "onUpdate:modelValue"])) : _ctx.isLeaf && _ctx.node.checked ? (vue.openBlock(), vue.createBlock("i", _hoisted_2)) : vue.createCommentVNode("v-if", true),
    vue.createCommentVNode(" content "),
    vue.createVNode(_component_node_content),
    vue.createCommentVNode(" postfix "),
    !_ctx.isLeaf ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 3 }, [
      _ctx.node.loading ? (vue.openBlock(), vue.createBlock("i", _hoisted_3)) : (vue.openBlock(), vue.createBlock("i", _hoisted_4))
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(_component_el_scrollbar, {
    ...
    default: vue.withCtx(() => [
      ...
      _ctx.isEmpty ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$1, vue.toDisplayString(_ctx.t("el.cascader.noData")), 1)) : _ctx.panel.isHoverMenu ? (vue.openBlock(), vue.createBlock("svg", _hoisted_2$1, null, 512)) : vue.createCommentVNode("v-if", true)
    ]),
    _: 1
